...
export const metadata: Metadata = {
  title:
    "404 Page Not Found - Smart Information Technologies",
  description:
    "Smart Information Technologies - 404 Page Not Found",
};
  ...
  return (
    <>
      ...
      <div className="mxd-floating-img floating-bg">
        <div className="mxd-floating-img__item mxd-rotate">
          <Image
            alt="Image"
                    ...
                    <div className="row g-0">
                      <div className="col-12 col-xl-6 mxd-grid-item no-margin">
                        <Link
                          ...
                          href={`https://www.smartitdigital.com`}
                        >

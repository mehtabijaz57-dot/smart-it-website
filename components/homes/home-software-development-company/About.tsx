              ...
              <div className="col-12 col-xl-5 mxd-grid-item no-margin">
                <div className="mxd-block__name">
                  <RevealText as="h2" className="reveal-type anim-uni-in-up">
                    {/* Fast Growing IT Services Company. */}
                ...
                <div className="mxd-block__content">
                  <div className="mxd-block__paragraph">
                    <p className="t-large t-bright anim-uni-in-up">
                      ...
                      Our mission is to Empower and Enhance the lives of Billions of users through Profound technology solutions.
                      We invite you to Think Big and join this movement as our Clients, Partners and Employees.                    </p>

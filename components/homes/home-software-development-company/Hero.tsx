              ...
              <div className="mxd-hero-01__title-wrap">
                ...
                <div className="mxd-hero-01__images mxd-floating-img">
                  <div className="hero-01-image image-01 mxd-floating-img__item loading__fade">
                    <Image
                      ...
                      alt="Hero Image"
                      src="/img/hero/03_hero-imgjj.png"
                      width={700}
                      height={687}
                    />
                  </div>
                  <div className="hero-01-image image-02 mxd-floating-img__item loading__fade">
                    <Image
                      className="mxd-move"
                      alt="Hero Image"
                      src="/img/hero/02_hero-imgtt.png"
                      width={700}
                      height={798}
                    />
                  </div>
                  <div className="hero-01-image image-03 mxd-floating-img__item loading__fade">
                    <Image
                      className="mxd-rotate"
                      alt="Hero Image"
                      src="/img/hero/01_hero-imghhh.png"
                      width={700}
                      height={704}
                    />
                  </div>
                ...
                <h1 className="hero-01-title">
                  <span className="hero-01-title__row loading__item">
                    <em className="hero-01-title__item">Smart</em>
                  ...
                  <span className="hero-01-title__row loading__item">
                    ...
                    <em className="hero-01-title__item">built for growth</em>
                  </span>
                </h1>
              </div>
            </div>
            ...
            <div className="mxd-hero-01__bottom">
              <div className="mxd-hero-01__data-wrap">
                      ...
                      <g>
                        ...
                        <text>
                          ...
                          <textPath xlinkHref="#textPath">
                            Smart Information Technologies * IT Growth Partner  *
                          </textPath>
                        </text>
                      </g>
                    </AnimateRotation>
                ...
                <div className="mxd-hero-01__data-descr loading__fade">
                  <p className="t-bright">
                    {/* Accelerate your projects, meet your goals fast & affordably. Strategic minds for your company's growth. */}
                    We help businesses design, build, and scale secure digital solutions —
                    from custom software to cloud, AI, and cybersecurity.
                  </p>
                </div>
              ...
              <div className="mxd-hero-01__video-wrap loading__item">
                <video
                  ...
                  loop
                  muted
                  poster="img/hero/imghomei.jpg"
                >
                  <source type="video/mp4" src="video/videohomei.mp4" />
                </video>
                <div className="mxd-hero-01__video-btn">
                  <VideoModalButton videoSrc="https://www.youtube.com/watch?v=2CeIkJTr-s4" />
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="mxd-divider">
            <div className="mxd-divider__video">
              <VideoParallax
                ...
                src="/video/videohomehello.mp4"
                poster="/img/hero/videohomehello.jpg"
              />
            </div>
          </div>
        </div>

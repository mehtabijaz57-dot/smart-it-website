            ...
            <div className="mxd-hero-01__bottom">
              ...
              <div className="mxd-hero-01__video-wrap loading__item">
                <video
                  ...
                  loop
                  muted
                  poster="video/540x310_video-1.mp4"
                >
                  <source type="video/mp4" src="video/540x310_video-1.mp4" />
                  <source type="video/webm" src="video/540x310_video-1.mp4" />
                  <source type="video/ogv" src="video/540x310_video-1.mp4" />
                </video>

...
const defaultDesc = `Fresh perspectives on software development, AI, cloud, and digital innovation — curated to help businesses stay ahead in a fast-changing tech world.`;
                ...
                {blogs1.map((item, idx) => (
                  ...
                  >
                    ...
                    <div className="mxd-blog-preview__data">
                      <Link className="anim-uni-in-up" href={`blog-standard`}>
                        {item.title.before ?? ""}{" "}

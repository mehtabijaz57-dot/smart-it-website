                  ...
                  <div className="mxd-block__content">
                    <div className="mxd-block__inner-headline">
                      ...
                      <p className="inner-headline__text t-large t-bright loading__item">
                        Cloud migration isn’t a technical task — it’s a leadership responsibility. Our senior architects take full ownership of every transition, ensuring secure, controlled, and strategy-led execution.
                      </p>
                    </div>
                  </div>
                </div>
          ...
          <div className="mxd-container__circle loading__fade">
            ...
            >
              ...
              >
                ...
                <g>
                  ...
                  <text>
                    ...
                    **Smart Information Tech * IT Growth Partner ***{" "}
                    </textPath>
                  </text>
                </g>
              </AnimateRotation>
              ...
              <Image
                ...
                width={300}
                height={300}
                src="/img/icons/h70_stats-003.png"
              />
            </Link>
          </div>

              ...
              <div className="mxd-project__content">
                <div className="mxd-project__paragraph">
                  <p className="t-large t-bright anim-uni-in-up">
                     Cloud environments change rapidly during migration and scaling.
                  </p>
                  <p className="anim-uni-in-up">
                   
                    Traditional tools fail to detect threats hidden in APIs and identities.
                    Attackers exploit misconfigurations and weak access controls.
                    Lack of visibility increases breach and downtime risks.
            ...
            <div className="row gx-0">
              ...
              <div className="col-12 col-xl-7 mxd-project-cards__item mxd-grid-item anim-uni-scale-in-right">
                <div className="mxd-project-cards__inner bg-base-tint radius-m">
                  <Image
                    alt="Project Preview"
                    src="/img/works/services/service26_4.jpg"
                    width={1400}
                    height={1000}
                  />
                </div>
              ...
              <div className="col-12 col-xl-5 mxd-project-cards__item mxd-grid-item anim-uni-scale-in-left">
                <div className="mxd-project-cards__inner bg-base-tint radius-m">
                  <Image
                    alt="Project Preview"
                    src="/img/works/services/service26_5.jpg"
                    width={1200}
                    height={1200}
                  />
                </div>

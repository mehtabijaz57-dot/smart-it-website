              ...
              <div className="mxd-project__content">
                <div className="mxd-project__paragraph">
                  <p className="t-large t-bright anim-uni-in-up">
                    Industrial sites operate with decades-old SCADA systems and proprietary protocols, trapping data in silos. 
                  </p>
                  <p className="anim-uni-in-up">
                    Standard cloud migrations risk downtime, safety issues, and operational disruption if applied without industrial-specific safeguards.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="row gx-0">
              ...
              <div className="col-12 col-xl-7 mxd-project-cards__item mxd-grid-item anim-uni-scale-in-right">
                <div className="mxd-project-cards__inner bg-base-tint radius-m">
                  <Image
                    alt="Project Preview"
                    src="/img/works/services/service31_4.jpg"
                    width={1400}
                    height={1000}
                  />
                </div>

              ...
              <div className="col-12 col-xl-10 mxd-grid-item no-margin">
                <div className="mxd-block__content">
                  <div className="mxd-block__inner-headline loading__item">
                    <h1 className="inner-headline__title"> Industrial IoT Cloud Migration Strategy</h1>
                  </div>
                </div>
              </div>
            ...
            <div className="row g-0">
              ...
              <div className="col-12 col-xl-6 mxd-grid-item no-margin">
                <div className="inner-headline__paragraph loading__item">
                  <p>
                    Modernizing legacy OT systems through secure, safety-first IIoT architectures that connect edge, cloud, and industrial intelligence—without disrupting operations.
                  </p>
                </div>
                      ...
                      <div className="row g-0">
                        <div className="col-12 col-md-6 col-xl-5 mxd-data-list__column loading__item">
                          <div className="mxd-data-list__item">
                            <p className="mxd-data-list__name">Focus Area</p>
                            <p className="mxd-data-list__content">OT–IT Convergence</p>
                          </div>
                          <div className="mxd-data-list__item">
                            <p className="mxd-data-list__name">Capability</p>
                        ...
                        <div className="col-12 col-md-6 col-xl-5 mxd-data-list__column loading__item">
                          <div className="mxd-data-list__item">
                            <p className="mxd-data-list__name">Solution Area</p>
                            <p className="mxd-data-list__content">
                              Industrial IoT Cloud Migration
                            </p>
                          </div>
                          <div className="mxd-data-list__item">
                            <p className="mxd-data-list__name">Service Domain</p>
                            <p className="mxd-data-list__content">
                             Industrial IoT & OT Modernization
                            </p>
                          </div>
                        </div>
                      </div>

    ...
    <>
              ...
              <div className="mxd-project__content">
                <div className="mxd-project__paragraph medium-text">
                  <p className="anim-uni-in-up">
                    We bridge OT and IT with IIoT Cloud Migration strategies, including Edge Gateways, protocol normalization, Digital Twin foundations, and zero-trust sensor security.
                  </p>
                  <p className="anim-uni-in-up">
                     Our approach modernizes equipment without replacing costly machinery while maintaining production uptime and safety.
                  </p>
                </div>
              </div>
            </div>
      ...
      <div className="mxd-project__block mxd-grid-item no-margin">
        <div className="mxd-divider">
          <BackgroundParallax
            scale={1.5}
            className="mxd-divider__image prj-details-img-031 parallax-img"
          />
        </div>
      </div>

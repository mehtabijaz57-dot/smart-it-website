              ...
              <div className="col-12 col-xl-10 mxd-grid-item no-margin">
                <div className="mxd-block__content">
                  <div className="mxd-block__inner-headline loading__item">
                    <h1 className="inner-headline__title">Legacy System Modernization Services</h1>
                  </div>
                </div>
              </div>
            ...
            <div className="row g-0">
              ...
              <div className="col-12 col-xl-6 mxd-grid-item no-margin">
                <div className="inner-headline__paragraph loading__item">
                  <p>
                    Your legacy systems shouldn’t slow your business down. <br />
                    Smart Information Technologies modernizes mission-critical applications using proven, risk-managed strategies—so you move from maintaining the past to building the future.
                  </p>
                </div>
                      ...
                      <div className="row g-0">
                        <div className="col-12 col-md-6 col-xl-5 mxd-data-list__column loading__item">
                          <div className="mxd-data-list__item">
                            ...
                            <p className="mxd-data-list__content">Cloud-Native Transformation</p>
                          </div>
                          <div className="mxd-data-list__item">
                        ...
                        <div className="col-12 col-md-6 col-xl-5 mxd-data-list__column loading__item">
                          <div className="mxd-data-list__item">
                            <p className="mxd-data-list__name">Includes</p>
                            <p className="mxd-data-list__content">
                            Re-architecture, Mainframe Modernization
                            </p>
                          </div>
                          <div className="mxd-data-list__item">
                            <p className="mxd-data-list__name">Approach</p>
                            <p className="mxd-data-list__content">
                              Risk-Managed, Incremental Modernization
                            </p>
                          </div>
                        </div>
                      </div>

              ...
              <div className="col-12 col-xl-10 mxd-grid-item no-margin">
                <div className="mxd-block__content">
                  <div className="mxd-block__inner-headline loading__item">
                    <h1 className="inner-headline__title">Microsoft Azure Cloud Migration </h1>
                  </div>
                </div>
              </div>
            ...
            <div className="row g-0">
              ...
              <div className="col-12 col-xl-6 mxd-grid-item no-margin">
                <div className="inner-headline__paragraph loading__item">
                  <p>
                   Smart Information Technologies helps enterprises migrate from legacy systems to a secure, scalable, and cost-optimized Microsoft Azure cloud. We go beyond “lift and shift” by building governed landing zones and modern, future-ready cloud architecture.
                  </p>
                </div>
                  ...
                  <div className="mxd-data-list">
                    <div className="container-fluid p-0">
                      <div className="row g-0">
                        ...
                        <div className="col-12 col-md-6 col-xl-5 mxd-data-list__column loading__item">
                          <div className="mxd-data-list__item">
                            <p className="mxd-data-list__name">Specialization</p>
                            <p className="mxd-data-list__content">
                              Enterprise Cloud & Hybrid Infrastructure
                            </p>
                          </div>
                          <div className="mxd-data-list__item">
                            <p className="mxd-data-list__name">Version</p>
                            <p className="mxd-data-list__content">
                              2026 Edition
                            </p>
                          </div>

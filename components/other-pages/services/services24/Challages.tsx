              ...
              <div className="mxd-project__content">
                <div className="mxd-project__paragraph">
                  <p className="t-large t-bright anim-uni-in-up">
                   Moving to the cloud is not just a technical upgrade but a strategic business decision.
                  </p>
                  <p className="anim-uni-in-up">

                    
                    Organizations struggle with understanding application dependencies and migration risks.
                    Security, compliance, and data residency concerns often delay cloud initiatives.
                    Without a clear plan, migrations become costly, risky, and difficult to control.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="row gx-0">
              ...
              <div className="col-12 col-xl-5 mxd-project-cards__item mxd-grid-item anim-uni-scale-in-right">
                <div className="mxd-project-cards__inner align-end bg-accent radius-m">
                  <Image
                    alt="Project Preview"
                    src="/img/works/services/service24_2.jpg"
                    width={1200}
                    height={1200}
                  />
                </div>
              ...
              <div className="col-12 col-xl-7 mxd-project-cards__item mxd-grid-item anim-uni-scale-in-left">
                <div className="mxd-project-cards__inner align-end bg-base-tint radius-m">
                  <Image
                    alt="Project Preview"
                    src="/img/works/services/service24_3.jpg"
                    width={1400}
                    height={1000}
                  />
                </div>

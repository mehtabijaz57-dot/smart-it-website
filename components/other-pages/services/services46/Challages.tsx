              ...
              <div className="mxd-project__content">
                <div className="mxd-project__paragraph">
                  <p className="t-large t-bright anim-uni-in-up">
                   Many Salesforce projects fail due to user resistance, not bad code.
                  </p>
                  <p className="anim-uni-in-up">
                    
                    Teams struggle with complex screens and disconnected data sources.
                    Manual admin work consumes valuable sales and service time.
                    The CRM becomes a record-keeping tool instead of a growth engine.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="row gx-0">
              ...
              <div className="col-12 col-xl-7 mxd-project-cards__item mxd-grid-item anim-uni-scale-in-right">
                <div className="mxd-project-cards__inner bg-base-tint radius-m">
                  <Image
                    alt="Project Preview"
                    src="/img/works/services/service46_4.jpg"
                    width={1400}
                    height={1000}
                  />
                </div>
              ...
              <div className="col-12 col-xl-5 mxd-project-cards__item mxd-grid-item anim-uni-scale-in-left">
                <div className="mxd-project-cards__inner bg-base-tint radius-m">
                  <Image
                    alt="Project Preview"
                    src="/img/works/services/service46_5.jpg"
                    width={1200}
                    height={1200}
                  />
                </div>

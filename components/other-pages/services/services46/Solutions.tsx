    ...
    <>
              ...
              <div className="mxd-project__content">
                <div className="mxd-project__paragraph medium-text">
                  <p className="anim-uni-in-up">
                    We implement Data Cloud for real-time identity resolution across systems.
                    Agentforce automates lead follow-ups, support cases, and workflows.
                    
                  </p>
                  <p className="anim-uni-in-up">
                    Lightning Dynamic Forms simplify UI for faster onboarding.
                    DevOps governance ensures stable, scalable Salesforce releases.
                  </p>
                </div>
              </div>
            </div>
      ...
      <div className="mxd-project__block mxd-grid-item no-margin">
        <div className="mxd-divider">
          <BackgroundParallax
            scale={1.5}
            className="mxd-divider__image prj-details-img-046 parallax-img"
          />
        </div>
      </div>

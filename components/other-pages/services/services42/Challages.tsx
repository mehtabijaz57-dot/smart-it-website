              ...
              <div className="mxd-project__content">
                <div className="mxd-project__paragraph">
                  <p className="t-large t-bright anim-uni-in-up">
                    Government agencies operate under strict regulatory mandates.
                    Legacy mainframes create long-term technical debt.
                   

                  </p>
                  <p className="anim-uni-in-up">

                     Cyber threats from nation-state actors continue to rise.
                    Authority to Operate (ATO) processes slow innovation.
                    Citizens expect seamless digital experiences.
                    Leaders must modernize without failing audits.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="row gx-0">
              ...
              <div className="col-12 col-xl-5 mxd-project-cards__item mxd-grid-item anim-uni-scale-in-right">
                <div className="mxd-project-cards__inner align-end bg-accent radius-m">
                  <Image
                    alt="Project Preview"
                    src="/img/works/services/service42_2.jpg"
                    width={1200}
                    height={1200}
                  />
                </div>
              ...
              <div className="col-12 col-xl-7 mxd-project-cards__item mxd-grid-item anim-uni-scale-in-left">
                <div className="mxd-project-cards__inner align-end bg-base-tint radius-m">
                  <Image
                    alt="Project Preview"
                    src="/img/works/services/service42_3.jpg"
                    width={1400}
                    height={1000}
                  />
                </div>

              ...
              <div className="mxd-project__content">
                <div className="mxd-project__paragraph">
                  <p className="t-large t-bright anim-uni-in-up">
                    Traditional PHP applications built years ago often suffer from slow performance, security risks, and messy code structure.
                  </p>
                  <p className="anim-uni-in-up">
                    As features grow, the system becomes harder to maintain and even harder to scale. Database overload, unoptimized queries, and outdated architecture create serious performance and stability issues.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="row gx-0">
              ...
              <div className="col-12 col-xl-7 mxd-project-cards__item mxd-grid-item anim-uni-scale-in-right">
                <div className="mxd-project-cards__inner bg-base-tint radius-m">
                  <Image
                    alt="Project Preview"
                    src="/img/works/services/service49_4.jpg"
                    width={1400}
                    height={1000}
                  />
                </div>
              ...
              <div className="col-12 col-xl-5 mxd-project-cards__item mxd-grid-item anim-uni-scale-in-left">
                <div className="mxd-project-cards__inner bg-base-tint radius-m">
                  <Image
                    alt="Project Preview"
                     src="/img/works/services/service49_5.jpg"
                    width={1200}
                    height={1200}
                  />
                </div>

              ...
              <div className="col-12 col-xl-10 mxd-grid-item no-margin">
                <div className="mxd-block__content">
                  <div className="mxd-block__inner-headline loading__item">
                    <h1 className="inner-headline__title">PHP Web Application Modernization</h1>
                  </div>
                </div>
              </div>
            ...
            <div className="row g-0">
              ...
              <div className="col-12 col-xl-6 mxd-grid-item no-margin">
                <div className="inner-headline__paragraph loading__item">
                  <p>
                    Re-architect legacy PHP apps into secure, high-performance, modern platforms built for scalability, maintainability, and long-term growth.
                  </p>
                </div>
                      ...
                      <div className="row g-0">
                        <div className="col-12 col-md-6 col-xl-5 mxd-data-list__column loading__item">
                          <div className="mxd-data-list__item">
                            ...
                            <p className="mxd-data-list__content">Web Application Modernization</p>
                          </div>
                          <div className="mxd-data-list__item">
                            <p className="mxd-data-list__name">Focus</p>
                            <p className="mxd-data-list__content">
                             Performance, Security <br /> & Clean Architecture
                            </p>
                          </div>
                        </div>
                        <div className="col-12 col-md-6 col-xl-5 mxd-data-list__column loading__item">
                          <div className="mxd-data-list__item">
                            <p className="mxd-data-list__name">Technology</p>
                            <p className="mxd-data-list__content">
                              PHP 8, Laravel, Symfony, REST APIs
                            </p>
                          </div>
                          <div className="mxd-data-list__item">

              ...
              <div className="col-12 col-xl-10 mxd-grid-item no-margin">
                <div className="mxd-block__content">
                  <div className="mxd-block__inner-headline loading__item">
                    <h1 className="inner-headline__title">AWS Cloud Migration Consulting Services</h1>
                  </div>
                </div>
              </div>
            ...
            <div className="row g-0">
              ...
              <div className="col-12 col-xl-6 mxd-grid-item no-margin">
                <div className="inner-headline__paragraph loading__item">
                  <p>
                    Designing secure, cost-predictable AWS architectures that turn migration into a long-term business advantage.
                  </p>
                </div>
                      ...
                      <div className="row g-0">
                        <div className="col-12 col-md-6 col-xl-5 mxd-data-list__column loading__item">
                          <div className="mxd-data-list__item">
                            ...
                            <p className="mxd-data-list__content">Enterprise & Mid-Market Organizations</p>
                          </div>
                          <div className="mxd-data-list__item">
                            <p className="mxd-data-list__name">Core Services</p>
                            <p className="mxd-data-list__content">
                              AWS Migration · Modernization · FinOps
                            </p>
                          </div>
                        </div>
                        <div className="col-12 col-md-6 col-xl-5 mxd-data-list__column loading__item">
                          <div className="mxd-data-list__item">
                            <p className="mxd-data-list__name">Built For</p>
                            <p className="mxd-data-list__content">
                             AWS 2026 Standards
                            </p>
                          </div>
                          <div className="mxd-data-list__item">
                            <p className="mxd-data-list__name">Migration Era</p>
                            <p className="mxd-data-list__content">

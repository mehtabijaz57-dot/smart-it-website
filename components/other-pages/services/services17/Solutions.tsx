    ...
    <>
              ...
              <div className="mxd-project__content">
                <div className="mxd-project__paragraph medium-text">
                  <p className="anim-uni-in-up">
                    We implement Odoo as a centralized digital backbone across all business functions.
                    Modular apps replace fragmented tools while preserving your unique workflows.
                  </p>
                  <p className="anim-uni-in-up">
                    The result is automation, clarity, and a scalable ERP foundation.
                  </p>
                </div>
              </div>
            </div>
      ...
      <div className="mxd-project__block mxd-grid-item no-margin">
        <div className="mxd-divider">
          <BackgroundParallax
            scale={1.5}
            className="mxd-divider__image prj-details-img-017 parallax-img"
          />
        </div>
      </div>

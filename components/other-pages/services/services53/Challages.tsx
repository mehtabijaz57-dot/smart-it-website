              ...
              <div className="mxd-project__content">
                <div className="mxd-project__paragraph">
                  <p className="t-large t-bright anim-uni-in-up">
                     Legacy web applications become difficult to maintain as business logic grows.
                  </p>
                  <p className="anim-uni-in-up">
                   
                    Tightly coupled codebases slow feature delivery and increase regression risk.
                    Security gaps emerge as frameworks age and patches are delayed.
                    Data-heavy workflows strain poorly structured backend systems.
                    These issues limit scalability and long-term system reliability.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="row gx-0">
              ...
              <div className="col-12 col-xl-7 mxd-project-cards__item mxd-grid-item anim-uni-scale-in-right">
                <div className="mxd-project-cards__inner bg-base-tint radius-m">
                  <Image
                    alt="Project Preview"
                    src="/img/works/services/service53_4.jpg"
                    width={1400}
                    height={1000}
                  />
                </div>
              ...
              <div className="col-12 col-xl-5 mxd-project-cards__item mxd-grid-item anim-uni-scale-in-left">
                <div className="mxd-project-cards__inner bg-base-tint radius-m">
                  <Image
                    alt="Project Preview"
                    src="/img/works/services/service53_5.jpg"
                    width={1200}
                    height={1200}
                  />
                </div>

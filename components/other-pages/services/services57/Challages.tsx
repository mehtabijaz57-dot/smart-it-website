              ...
              <div className="mxd-project__content">
                <div className="mxd-project__paragraph">
                  <p className="t-large t-bright anim-uni-in-up">
                    Legacy applications limit scalability, flexibility, and integration capabilities.
                  </p>
                  <p className="anim-uni-in-up">
                    
                    Outdated technologies increase maintenance costs and security risks.
                    Slow performance affects user experience and business productivity.
                    These systems prevent organizations from adopting modern digital solutions.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="row gx-0">
              ...
              <div className="col-12 col-xl-7 mxd-project-cards__item mxd-grid-item anim-uni-scale-in-right">
                <div className="mxd-project-cards__inner bg-base-tint radius-m">
                  <Image
                    alt="Project Preview"
                    src="/img/works/services/service57_4.webp"
                    width={1400}
                    height={1000}
                  />
                </div>
              ...
              <div className="col-12 col-xl-5 mxd-project-cards__item mxd-grid-item anim-uni-scale-in-left">
                <div className="mxd-project-cards__inner bg-base-tint radius-m">
                  <Image
                    alt="Project Preview"
                    src="/img/works/services/service57_5.webp"
                    width={1200}
                    height={1200}
                  />
                </div>

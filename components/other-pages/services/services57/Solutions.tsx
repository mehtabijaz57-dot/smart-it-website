    ...
    <>
              ...
              <div className="mxd-project__content">
                <div className="mxd-project__paragraph medium-text">
                  <p className="anim-uni-in-up">
                    We analyze your legacy systems and design a modernization roadmap.
                    Applications are re-engineered using modern architectures and cloud platforms.
                   
                  </p>
                  <p className="anim-uni-in-up">
                     We improve scalability, security, and performance.
                    This ensures future-ready applications that support business growth.
                  </p>
                </div>
              </div>
            </div>
      ...
      <div className="mxd-project__block mxd-grid-item no-margin">
        <div className="mxd-divider">
          <BackgroundParallax
            scale={1.5}
            className="mxd-divider__image prj-details-img-057 parallax-img"
          />
        </div>
      </div>

              ...
              <div className="col-12 col-xl-10 mxd-grid-item no-margin">
                <div className="mxd-block__content">
                  <div className="mxd-block__inner-headline loading__item">
                    <h1 className="inner-headline__title">Managed IT Services</h1>
                  </div>
                </div>
              </div>
            ...
            <div className="row g-0">
              ...
              <div className="col-12 col-xl-6 mxd-grid-item no-margin">
                <div className="inner-headline__paragraph loading__item">
                  <p>
                    Smart Information Technology provides end-to-end managed IT services
                    that keep your infrastructure secure, stable, and optimized.
                    We proactively monitor, manage, and support your IT environment
                      ...
                      <div className="row g-0">
                        <div className="col-12 col-md-6 col-xl-5 mxd-data-list__column loading__item">
                          <div className="mxd-data-list__item">
                            <p className="mxd-data-list__name">Engagement Type</p>
                            <p className="mxd-data-list__content">Fully Managed IT <br /> Services</p>
                          </div>
                          <div className="mxd-data-list__item">
                            <p className="mxd-data-list__name">Service Model</p>
                        ...
                        <div className="col-12 col-md-6 col-xl-5 mxd-data-list__column loading__item">
                          <div className="mxd-data-list__item">
                            <p className="mxd-data-list__name">Industry Focus</p>
                            <p className="mxd-data-list__content">
                              Enterprise & Growing Businesses
                            </p>
                          </div>
                          <div className="mxd-data-list__item">
                            <p className="mxd-data-list__name">Coverage</p>
                            <p className="mxd-data-list__content">

              ...
              <div className="mxd-project__content">
                <div className="mxd-project__paragraph">
                  <p className="t-large t-bright anim-uni-in-up">
                    Most factories still operate with isolated PLCs, aging CNC machines, and spreadsheets that hide critical performance data.
                  </p>
                  <p className="anim-uni-in-up">

                    Legacy assets were never designed to integrate with cloud-native analytics platforms.
                    Meanwhile, global supply chain volatility and cybersecurity threats are increasing operational risk.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="row gx-0">
              ...
              <div className="col-12 col-xl-7 mxd-project-cards__item mxd-grid-item anim-uni-scale-in-right">
                <div className="mxd-project-cards__inner bg-base-tint radius-m">
                  <Image
                    alt="Project Preview"
                    src="/img/works/services/service36_4.jpg"
                    width={1400}
                    height={1000}
                  />
                </div>
              ...
              <div className="col-12 col-xl-5 mxd-project-cards__item mxd-grid-item anim-uni-scale-in-left">
                <div className="mxd-project-cards__inner bg-base-tint radius-m">
                  <Image
                    alt="Project Preview"
                    src="/img/works/services/service36_5.jpg"
                    width={1200}
                    height={1200}
                  />
                </div>

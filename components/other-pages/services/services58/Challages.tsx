            ...
            <div className="col-12 col-xl-5 mxd-grid-item no-margin">
              <div className="mxd-project__subtitle">
                <RevealText as="h2" className="reveal-type anim-uni-in-up">
                  The Problem with Rigid ERP Systems
                </RevealText>
              </div>
            </div>
              ...
              <div className="mxd-project__content">
                <div className="mxd-project__paragraph">
                  <p className="t-large t-bright anim-uni-in-up">
                    Standard ERP solutions are built for generic use cases. 
                  </p>
                  <p className="anim-uni-in-up">
                   As businesses grow, these rigid systems fail to support unique workflows, approvals, reporting structures, and integrations — resulting in inefficiencies, manual workarounds, and operational bottlenecks.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="row gx-0">
              ...
              <div className="col-12 col-xl-7 mxd-project-cards__item mxd-grid-item anim-uni-scale-in-right">
                <div className="mxd-project-cards__inner bg-base-tint radius-m">
                  <Image
                    alt="Project Preview"
                    src="/img/works/services/service58_4.jpg"
                    width={1400}
                    height={1000}
                  />
                </div>

    ...
    <>
              ...
              <div className="mxd-project__content">
                <div className="mxd-project__paragraph medium-text">
                  <p className="anim-uni-in-up">
                    We analyze your operational workflows and customize ERP modules accordingly.
                   
                  </p>
                  <p className="anim-uni-in-up">
                     Advanced integrations ensure seamless data flow across departments.
                    Automation improves productivity and reduces manual errors.
                    Our solutions enhance visibility, control, and long-term scalability.
                  </p>
                </div>
              </div>
            </div>
      ...
      <div className="mxd-project__block mxd-grid-item no-margin">
        <div className="mxd-divider">
          <BackgroundParallax
            scale={1.5}
            className="mxd-divider__image prj-details-img-058 parallax-img"
          />
        </div>
      </div>

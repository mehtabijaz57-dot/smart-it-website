              ...
              <div className="mxd-project__content">
                <div className="mxd-project__paragraph">
                  <p className="t-large t-bright anim-uni-in-up">
                   Most analytics initiatives stop at dashboards that only explain past performance.
                  </p>
                  <p className="anim-uni-in-up">
                    
                    Predictive models often stay confined to data scientists’ local environments.
                    Critical features are rebuilt repeatedly, slowing innovation and increasing cost.
                    As data changes, model accuracy silently degrades without detection
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="row gx-0">
              ...
              <div className="col-12 col-xl-5 mxd-project-cards__item mxd-grid-item anim-uni-scale-in-right">
                <div className="mxd-project-cards__inner align-end bg-accent radius-m">
                  <Image
                    alt="Project Preview"
                    src="/img/works/services/service21_2.jpg"
                    width={1200}
                    height={1200}
                  />
                </div>
              ...
              <div className="col-12 col-xl-7 mxd-project-cards__item mxd-grid-item anim-uni-scale-in-left">
                <div className="mxd-project-cards__inner align-end bg-base-tint radius-m">
                  <Image
                    alt="Project Preview"
                    src="/img/works/services/service21_3.jpg"
                    width={1400}
                    height={1000}
                  />
                </div>

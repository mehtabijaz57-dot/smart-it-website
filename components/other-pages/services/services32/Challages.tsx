              ...
              <div className="mxd-project__content">
                <div className="mxd-project__paragraph">
                  <p className="t-large t-bright anim-uni-in-up">
                    Legacy on-premise ERP systems create data silos, delays, and operational inefficiencies.
                  </p>
                  <p className="anim-uni-in-up">
                    Manual reconciliations and fragmented reporting slow down financial decision-making.
                    Heavy customizations increase technical debt and complicate system upgrades.
                    Enterprises struggle to gain real-time visibility across finance, supply chain, and operations.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="row gx-0">
              ...
              <div className="col-12 col-xl-7 mxd-project-cards__item mxd-grid-item anim-uni-scale-in-right">
                <div className="mxd-project-cards__inner bg-base-tint radius-m">
                  <Image
                    alt="Project Preview"
                    src="/img/works/services/service32_4.jpg"
                    width={1400}
                    height={1000}
                  />
                </div>
              ...
              <div className="col-12 col-xl-5 mxd-project-cards__item mxd-grid-item anim-uni-scale-in-left">
                <div className="mxd-project-cards__inner bg-base-tint radius-m">
                  <Image
                    alt="Project Preview"
                    src="/img/works/services/service32_5.jpg"
                    width={1200}
                    height={1200}
                  />
                </div>

    ...
    <>
              ...
              <div className="mxd-project__content">
                <div className="mxd-project__paragraph medium-text">
                  <p className="anim-uni-in-up">
                    We implement 24/7 security monitoring powered by threat intelligence,
                    automation, and expert analysis. 

                  </p>
                  <p className="anim-uni-in-up">
                   Our proactive defense approach
                    identifies vulnerabilities early, detects suspicious activity, and
                    responds rapidly to minimize security incidents.
                  </p>
                </div>
              </div>
            </div>
      ...
      <div className="mxd-project__block mxd-grid-item no-margin">
        <div className="mxd-divider">
          <BackgroundParallax
            scale={1.5}
            className="mxd-divider__image prj-details-img-055 parallax-img"
          />
        </div>
      </div>

              ...
              <div className="col-12 col-xl-10 mxd-grid-item no-margin">
                <div className="mxd-block__content">
                  <div className="mxd-block__inner-headline loading__item">
                    <h1 className="inner-headline__title">SAP S/4HANA Transformation Services</h1>
                  </div>
                </div>
              </div>
            ...
            <div className="row g-0">
              ...
              <div className="col-12 col-xl-6 mxd-grid-item no-margin">
                <div className="inner-headline__paragraph loading__item">
                  <p>
                    Enabling clean-core, cloud-ready SAP S/4HANA transformations that turn legacy ERP into a real-time intelligent enterprise.
                  </p>
                </div>
                      ...
                      <div className="row g-0">
                        <div className="col-12 col-md-6 col-xl-5 mxd-data-list__column loading__item">
                          <div className="mxd-data-list__item">
                            ...
                            <p className="mxd-data-list__content">Enterprise ERP Transformation</p>
                          </div>
                          <div className="mxd-data-list__item">
                            <p className="mxd-data-list__name">Service Type</p>
                            <p className="mxd-data-list__content">
                              SAP Consulting & Migration
                            </p>
                          </div>
                        </div>
                        <div className="col-12 col-md-6 col-xl-5 mxd-data-list__column loading__item">
              ...
              <div className="col-12 col-xl-4 mxd-grid-item no-margin">
                <div className="inner-headline__tags loading__fade">
                  ...
                  <span className="tag tag-default tag-outline-medium">
                     Suite  Clean Core ERP Architecture
                  </span>
                  <span className="tag tag-default tag-outline-medium">
                    ECC to S/4HANA Brownfield vs.Greenfield
                  </span>
                </div>
              </div>
            </div>

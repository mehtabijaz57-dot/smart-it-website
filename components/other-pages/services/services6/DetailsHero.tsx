              ...
              <div className="col-12 col-xl-10 mxd-grid-item no-margin">
                <div className="mxd-block__content">
                  <div className="mxd-block__inner-headline loading__item">
                    <h1 className="inner-headline__title">Hybrid Cloud Solutions</h1>
                  </div>
                </div>
              </div>
            ...
            <div className="row g-0">
              ...
              <div className="col-12 col-xl-6 mxd-grid-item no-margin">
                <div className="inner-headline__paragraph loading__item">
                  <p>
                    For the modern enterprise, the cloud is no longer a destination—it is a capability. 
                    We design hybrid cloud environments that balance scalability, security, and control 
                    across on-premise and public cloud platforms.
                  </p>
                </div>

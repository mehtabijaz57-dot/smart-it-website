              ...
              <div className="mxd-project__content">
                <div className="mxd-project__paragraph medium-text">
                  <p className="anim-uni-in-up">
                    AI is no longer optional. Organizations that fail to adopt intelligent
                    systems risk falling behind in efficiency, innovation, and customer
                    experience. 
                  </p>
                  <p className="anim-uni-in-up">
                   We help businesses move from experimentation to
                    production-ready AI solutions that deliver real value.
                  </p>
                </div>
              </div>
            </div>

              ...
              <div className="mxd-project__content">
                <div className="mxd-project__paragraph">
                  ...
                  <p className="anim-uni-in-up">
                    We use a modern, modular AI stack that ensures scalability, security,
                    and long-term maintainability. Our solutions integrate seamlessly
                    with your existing systems and data infrastructure.

              ...
              <div className="mxd-project__content">
                <div className="mxd-project__paragraph">
                  <p className="t-large t-bright anim-uni-in-up">
                    Applications built 15 years ago often lack documentation and the original developers are long gone.
                  </p>
                  <p className="anim-uni-in-up">
                    
                    This makes cloud migration risky, forcing teams into lift-and-shift or costly rewrites.
                    The real blocker is not infrastructure, but understanding the legacy codebase.
                    Generative AI helps analyze, document, and prepare this code for safe modernization.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="row gx-0">
              ...
              <div className="col-12 col-xl-5 mxd-project-cards__item mxd-grid-item anim-uni-scale-in-right">
                <div className="mxd-project-cards__inner align-end bg-accent radius-m">
                  <Image
                    alt="Project Preview"
                    src="/img/works/services/service19_2.jpg"
                    width={1200}
                    height={1200}
                  />
                </div>
              ...
              <div className="col-12 col-xl-7 mxd-project-cards__item mxd-grid-item anim-uni-scale-in-left">
                <div className="mxd-project-cards__inner align-end bg-base-tint radius-m">
                  <Image
                    alt="Project Preview"
                    src="/img/works/services/service19_3.jpg"
                    width={1400}
                    height={1000}
                  />
                </div>

    ...
    <>
              ...
              <div className="mxd-project__content">
                <div className="mxd-project__paragraph medium-text">
                  <p className="anim-uni-in-up">
                    We replace fragile point-to-point links with scalable iPaaS and API-led design.
                   

                  </p>
                  <p className="anim-uni-in-up">
                    Your systems communicate in real-time through secure, governed pipelines.
                    Data flows automatically between cloud apps and legacy platforms.
                    A true connected ecosystem replaces manual dependency.
                  </p>
                </div>
              </div>
            </div>
      ...
      <div className="mxd-project__block mxd-grid-item no-margin">
        <div className="mxd-divider">
          <BackgroundParallax
            scale={1.5}
            className="mxd-divider__image prj-details-img-033 parallax-img"
          />
        </div>
      </div>

              ...
              <div className="mxd-project__content">
                <div className="mxd-project__paragraph">
                  <p className="t-large t-bright anim-uni-in-up">
                     Traditional React and SPA architectures grow slower over time.
                  </p>
                  <p className="anim-uni-in-up">                  
                    Large JavaScript bundles delay Time to Interactive on real devices.
                    Search engines penalize slow, client-heavy rendering models.
                    Performance issues directly impact SEO, conversions, and retention.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="row gx-0">
              ...
              <div className="col-12 col-xl-7 mxd-project-cards__item mxd-grid-item anim-uni-scale-in-right">
                <div className="mxd-project-cards__inner bg-base-tint radius-m">
                  <Image
                    alt="Project Preview"
                    src="/img/works/services/service48_3.jpg"
                    width={1400}
                    height={1000}
                  />
                </div>
              ...
              <div className="col-12 col-xl-5 mxd-project-cards__item mxd-grid-item anim-uni-scale-in-left">
                <div className="mxd-project-cards__inner bg-base-tint radius-m">
                  <Image
                    alt="Project Preview"
                    src="/img/works/services/service48_2.jpg"
                    width={1200}
                    height={1200}
                  />
                </div>

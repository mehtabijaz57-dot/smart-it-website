              ...
              <div className="mxd-project__content">
                <div className="mxd-project__paragraph">
                  <p className="t-large t-bright anim-uni-in-up">
                    Modern web development goes beyond visuals. It requires clean architecture, efficient data handling, and performance optimization at every layer.


                  </p>
                  <p className="anim-uni-in-up">
                    We design and engineer web platforms that are easy to scale, simple to maintain, and ready for real-world traffic.
                    From frontend interactions to backend systems, everything works as a single, reliable product.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="row gx-0">
              ...
              <div className="col-12 col-xl-7 mxd-project-cards__item mxd-grid-item anim-uni-scale-in-right">
                <div className="mxd-project-cards__inner bg-base-tint radius-m">
                  <Image
                    alt="Project Preview"
                    src="/img/works/services/service59_4.jpg"
                    width={1400}
                    height={1000}
                  />
                </div>
              ...
              <div className="col-12 col-xl-5 mxd-project-cards__item mxd-grid-item anim-uni-scale-in-left">
                <div className="mxd-project-cards__inner bg-base-tint radius-m">
                  <Image
                    alt="Project Preview"
                   src="/img/works/services/service59_5.jpg"
                    width={1200}
                    height={1200}
                  />
                </div>

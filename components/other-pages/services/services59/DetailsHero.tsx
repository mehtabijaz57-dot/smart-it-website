              ...
              <div className="col-12 col-xl-10 mxd-grid-item no-margin">
                <div className="mxd-block__content">
                  <div className="mxd-block__inner-headline loading__item">
                    <h1 className="inner-headline__title">Modern Web Development Services</h1>
                  </div>
                </div>
              </div>
            ...
            <div className="row g-0">
              ...
              <div className="col-12 col-xl-6 mxd-grid-item no-margin">
                <div className="inner-headline__paragraph loading__item">
                  <p>
                   We build modern, secure, and scalable web applications using proven frameworks and clean architecture. From frontend performance to backend scalability, our solutions are designed to support business .
                  </p>
                </div>
                      ...
                      <div className="row g-0">
                        <div className="col-12 col-md-6 col-xl-5 mxd-data-list__column loading__item">
                          <div className="mxd-data-list__item">
                            ...
                            <p className="mxd-data-list__content">Modern Web <br />Development</p>
                          </div>
                          <div className="mxd-data-list__item">
                            <p className="mxd-data-list__name">Focus</p>
                            <p className="mxd-data-list__content">
                              Performance, <br />Scalability, UX
                            </p>
                          </div>
                        </div>
                        <div className="col-12 col-md-6 col-xl-5 mxd-data-list__column loading__item">
                          <div className="mxd-data-list__item">
                            <p className="mxd-data-list__name">Technologies</p>
                            <p className="mxd-data-list__content">
                             React, Next.js, Node.js, Cloud
                            </p>
                          </div>
                          <div className="mxd-data-list__item">
                            <p className="mxd-data-list__name">Delivery</p>
                            <p className="mxd-data-list__content">
                             Agile & Production-Ready
                            </p>
                          </div>
                        </div>
                      </div>

              ...
              <div className="mxd-project__content">
                <div className="mxd-project__paragraph">
                  <p className="t-large t-bright anim-uni-in-up">
                    Retailers trapped in legacy platforms struggle to launch new features, integrate new channels, or optimize performance without expensive replatforming cycles.
                   
                  </p>
                  <p className="anim-uni-in-up">
                    Slow storefronts increase bounce rates.
                    Disconnected POS and warehouse systems cause overselling and stock discrepancies.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="row gx-0">
              ...
              <div className="col-12 col-xl-7 mxd-project-cards__item mxd-grid-item anim-uni-scale-in-right">
                <div className="mxd-project-cards__inner bg-base-tint radius-m">
                  <Image
                    alt="Project Preview"
                    src="/img/works/services/service37_4.jpg"
                    width={1400}
                    height={1000}
                  />
                </div>
              ...
              <div className="col-12 col-xl-5 mxd-project-cards__item mxd-grid-item anim-uni-scale-in-left">
                <div className="mxd-project-cards__inner bg-base-tint radius-m">
                  <Image
                    alt="Project Preview"
                    src="/img/works/services/service37_5.jpg"
                    width={1200}
                    height={1200}
                  />
                </div>

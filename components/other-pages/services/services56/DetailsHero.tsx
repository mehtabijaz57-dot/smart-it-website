              ...
              <div className="col-12 col-xl-10 mxd-grid-item no-margin">
                <div className="mxd-block__content">
                  <div className="mxd-block__inner-headline loading__item">
                    <h1 className="inner-headline__title">IoT & Digital Twin Solutions</h1>
                  </div>
                </div>
              </div>
            ...
            <div className="row g-0">
              ...
              <div className="col-12 col-xl-6 mxd-grid-item no-margin">
                <div className="inner-headline__paragraph loading__item">
                  <p>
                    We design intelligent IoT ecosystems and Digital Twin platforms that turn real-time data into predictive insights, operational efficiency, and smarter decision-making across industrial and enterprise environments.
                  </p>
                </div>
                      ...
                      <div className="row g-0">
                        <div className="col-12 col-md-6 col-xl-5 mxd-data-list__column loading__item">
                          <div className="mxd-data-list__item">
                            ...
                            <p className="mxd-data-list__content">IoT & Digital Twin Implementation</p>
                          </div>
                          <div className="mxd-data-list__item">
                            <p className="mxd-data-list__name">Service Scope</p>
                            <p className="mxd-data-list__content">
                              Asset Monitoring & Simulation
                            </p>
                          </div>
                        </div>
                        <div className="col-12 col-md-6 col-xl-5 mxd-data-list__column loading__item">
                          <div className="mxd-data-list__item">
                            ...
                            <p className="mxd-data-list__content">
                              IoT Sensors, Cloud & AI Analytics
                            </p>
                          </div>
                          <div className="mxd-data-list__item">

              ...
              <div className="col-12 col-xl-10 mxd-grid-item no-margin">
                <div className="mxd-block__content">
                  <div className="mxd-block__inner-headline loading__item">
                    <h1 className="inner-headline__title">Digital Twin Cloud Migration Strategy</h1>
                  </div>
                </div>
              </div>
              ...
              <div className="col-12 col-xl-6 mxd-grid-item no-margin">
                <div className="inner-headline__paragraph loading__item">
                  <p>
                    ...
                    We migrate Digital Twins to cloud-native platforms enabling real-time simulation, OpenUSD interoperability, and bi-directional IoT intelligence
                  </p>
                </div>
                      ...
                      <div className="row g-0">
                        <div className="col-12 col-md-6 col-xl-5 mxd-data-list__column loading__item">
                          <div className="mxd-data-list__item">
                            ...
                            <p className="mxd-data-list__content">Digital Twin Cloud Migration</p>
                          </div>
                          <div className="mxd-data-list__item">
                            <p className="mxd-data-list__name">Focus Areas</p>
                            <p className="mxd-data-list__content">
                              Executable Digital  <br />Twins (xDT)
                            </p>
                          </div>
                        </div>
                        <div className="col-12 col-md-6 col-xl-5 mxd-data-list__column loading__item">
                          <div className="mxd-data-list__item">
                            ...
                            <p className="mxd-data-list__content">
                              Azure Digital Twins · Nvidia Omniverse
                            </p>
                          </div>
                          <div className="mxd-data-list__item">
                            <p className="mxd-data-list__name">Use Cases</p>
                            <p className="mxd-data-list__content">
                              Manufacturing · Energy · Smart Cities
                            </p>
                          </div>
                        </div>
                      </div>

    ...
    <>
            ...
            <div className="col-12 col-xl-5 mxd-grid-item no-margin">
              <div className="mxd-project__subtitle">
                <RevealText as="h2" className="reveal-type anim-uni-in-up">
                  Digital Twin Cloud Migration Strategy
                </RevealText>
              </div>
            </div>
              ...
              <div className="mxd-project__content">
                <div className="mxd-project__paragraph medium-text">
                  <p className="anim-uni-in-up">
                    We migrate Digital Twins to cloud-native platforms using OpenUSD and GPU acceleration.
                    
                  </p>
                  <p className="anim-uni-in-up">
                    Executable Digital Twins (xDT) enable real-time edge decisions with cloud intelligence.
                    This creates scalable, secure, and interoperable twin ecosystems.
                  </p>
                </div>
              </div>
            </div>
      ...
      <div className="mxd-project__block mxd-grid-item no-margin">
        <div className="mxd-divider">
          <BackgroundParallax
            scale={1.5}
            className="mxd-divider__image prj-details-img-030 parallax-img"
          />
        </div>
      </div>

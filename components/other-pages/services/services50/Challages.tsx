              ...
              <div className="mxd-project__content">
                <div className="mxd-project__paragraph">
                  <p className="t-large t-bright anim-uni-in-up">
                        Many web applications fail to scale because of unstructured code, weak security, and poor database design.
                  </p>
                  <p className="anim-uni-in-up">
                 As features increase, performance drops and maintenance becomes difficult. Laravel solves this with a clean MVC pattern, strong security, and organized architecture.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="row gx-0">
              ...
              <div className="col-12 col-xl-7 mxd-project-cards__item mxd-grid-item anim-uni-scale-in-right">
                <div className="mxd-project-cards__inner bg-base-tint radius-m">
                  <Image
                    alt="Project Preview"
                    src="/img/works/services/service50_3.jpg"
                    width={1400}
                    height={1000}
                  />
                </div>
              ...
              <div className="col-12 col-xl-5 mxd-project-cards__item mxd-grid-item anim-uni-scale-in-left">
                <div className="mxd-project-cards__inner bg-base-tint radius-m">
                  <Image
                    alt="Project Preview"
                      src="/img/works/services/service50_5.jpg"
                    width={1200}
                    height={1200}
                  />
                </div>

    ...
    <>
              ...
              <div className="mxd-project__content">
                <div className="mxd-project__paragraph medium-text">
                  <p className="anim-uni-in-up">
                    Laravel’s MVC structure separates business logic from presentation, making applications easier to maintain and extend.
                  </p>
                  <p className="anim-uni-in-up">
                    We implement service layers, repositories, and optimized database design for long-term scalability.
                  </p>
                </div>
              </div>
            </div>
      ...
      <div className="mxd-project__block mxd-grid-item no-margin">
        <div className="mxd-divider">
          <BackgroundParallax
            scale={1.5}
            className="mxd-divider__image prj-details-img-050 parallax-img"
          />
        </div>
      </div>

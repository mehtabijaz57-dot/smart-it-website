              ...
              <div className="col-12 col-xl-10 mxd-grid-item no-margin">
                <div className="mxd-block__content">
                  <div className="mxd-block__inner-headline loading__item">
                    <h1 className="inner-headline__title">AI & Machine Learning Platforms</h1>
                  </div>
                </div>
              </div>
            ...
            <div className="row g-0">
              ...
              <div className="col-12 col-xl-6 mxd-grid-item no-margin">
                <div className="inner-headline__paragraph loading__item">
                  <p>
                   Building production-ready AI systems that scale securely in the cloud.
                  Closing the deployment gap with MLOps, GPU optimization, and governed AI platforms.
                  </p>
                </div>

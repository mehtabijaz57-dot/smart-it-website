              ...
              <div className="mxd-project__content">
                <div className="mxd-project__paragraph">
                  <p className="t-large t-bright anim-uni-in-up">
                    Enterprises on Dynamics AX, NAV, or GP face rising infrastructure costs and slow upgrades.
                    Hard-coded customizations create technical debt and frequent system breakage.
                  </p>
                  <p className="anim-uni-in-up">
                    
                    Data remains siloed across ERP, CRM, and Office tools.
                    Manual workflows delay decisions and limit scalability.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="row gx-0">
              ...
              <div className="col-12 col-xl-7 mxd-project-cards__item mxd-grid-item anim-uni-scale-in-right">
                <div className="mxd-project-cards__inner bg-base-tint radius-m">
                  <Image
                    alt="Project Preview"
                    src="/img/works/services/service18_4.jpg"
                    width={1400}
                    height={1000}
                  />
                </div>
              ...
              <div className="col-12 col-xl-5 mxd-project-cards__item mxd-grid-item anim-uni-scale-in-left">
                <div className="mxd-project-cards__inner bg-base-tint radius-m">
                  <Image
                    alt="Project Preview"
                  src="/img/works/services/service18_5.jpg"
                    width={1200}
                    height={1200}
                  />
                </div>

    ...
    <>
          ...
          <div className="row gx-0">
            <div className="col-12 col-xl-5 mxd-grid-item no-margin">
              <div className="mxd-project__subtitle">
                ...
                Component - <br />Based Architecture
                </RevealText>
              </div>
            </div>
              ...
              <div className="mxd-project__content">
                <div className="mxd-project__paragraph medium-text">
                  <p className="anim-uni-in-up">
                   React Native’s component-driven structure keeps UI, logic, and state well organized, making mobile apps easier to maintain and extend.
                  </p>
                  <p className="anim-uni-in-up">
                    We implement reusable components, proper state management, and optimized API handling for long-term scalability.
                  </p>
                </div>
              </div>
            </div>
      ...
      <div className="mxd-project__block mxd-grid-item no-margin">
        <div className="mxd-divider">
          <BackgroundParallax
            scale={1.5}
            className="mxd-divider__image prj-details-img-051 parallax-img"
          />
        </div>
      </div>

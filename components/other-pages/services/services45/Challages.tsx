              ...
              <div className="mxd-project__content">
                <div className="mxd-project__paragraph">
                  <p className="t-large t-bright anim-uni-in-up">
                    Most cloud migrations fail because they focus on servers, not data.
                  </p>
                  <p className="anim-uni-in-up">
                    
                    Teams lift and shift workloads without preparing data for analytics or AI.
                    This creates modern infrastructure running outdated intelligence.
                    The result is higher cloud bills with no real business acceleration.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="row gx-0">
              ...
              <div className="col-12 col-xl-7 mxd-project-cards__item mxd-grid-item anim-uni-scale-in-right">
                <div className="mxd-project-cards__inner bg-base-tint radius-m">
                  <Image
                    alt="Project Preview"
                    src="/img/works/services/service45_4.jpg"
                    width={1400}
                    height={1000}
                  />
                </div>
              ...
              <div className="col-12 col-xl-5 mxd-project-cards__item mxd-grid-item anim-uni-scale-in-left">
                <div className="mxd-project-cards__inner bg-base-tint radius-m">
                  <Image
                    alt="Project Preview"
                     src="/img/works/services/service45_5.jpg"
                    width={1200}
                    height={1200}
                  />
                </div>

    ...
    <>
              ...
              <div className="mxd-project__content">
                <div className="mxd-project__paragraph medium-text">
                  <p className="anim-uni-in-up">
                    We deliver a Smart City Cloud Migration Strategy that unifies
                     fragmented urban systems into a secure, cloud-native fabric.
                  </p>
                  <p className="anim-uni-in-up">
                   
                    Legacy infrastructure is modernized for interoperable data flow.
                    This enables real-time analytics and scalable city services.
      ...
      <div className="mxd-project__block mxd-grid-item no-margin">
        <div className="mxd-divider">
          <BackgroundParallax
            scale={1.5}
            className="mxd-divider__image prj-details-img-029 parallax-img"
          />
        </div>
      </div>

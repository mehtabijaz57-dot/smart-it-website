              ...
              <div className="mxd-project__content">
                <div className="mxd-project__paragraph">
                  <p className="t-large t-bright anim-uni-in-up">
                   Traditional backend systems struggle to scale with modern application demands.
                  </p>
                  <p className="anim-uni-in-up">
                    
                    Monolithic architectures slow down deployments and increase failure risk.
                    Synchronous processing creates performance bottlenecks under high traffic.
                    Legacy backends limit real-time capabilities and API flexibility.
                    These constraints directly impact product velocity and user experience.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="row gx-0">
              ...
              <div className="col-12 col-xl-5 mxd-project-cards__item mxd-grid-item anim-uni-scale-in-right">
                <div className="mxd-project-cards__inner align-end bg-accent radius-m">
                  <Image
                    alt="Project Preview"
                    src="/img/works/services/service52_2.jpg"
                    width={1200}
                    height={1200}
                  />
                </div>
              ...
              <div className="col-12 col-xl-7 mxd-project-cards__item mxd-grid-item anim-uni-scale-in-left">
                <div className="mxd-project-cards__inner align-end bg-base-tint radius-m">
                  <Image
                    alt="Project Preview"
                     src="/img/works/services/service52_3.jpg"
                    width={1400}
                    height={1000}
                  />
                </div>

              ...
              <div className="mxd-project__content">
                <div className="mxd-project__paragraph">
                  <p className="t-large t-bright anim-uni-in-up">
                   Moving vulnerable workloads to the cloud amplifies existing security gaps.
                    Even minor misconfigurations can expose sensitive data within minutes.
                  </p>
                  <p className="anim-uni-in-up">
                    
                    Legacy application flaws often become critical in cloud environments.
                    Configuration drift from best practices creates hidden weaknesses.
                    These risks must be identified and addressed before migration begins.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="row gx-0">
              ...
              <div className="col-12 col-xl-7 mxd-project-cards__item mxd-grid-item anim-uni-scale-in-right">
                <div className="mxd-project-cards__inner bg-base-tint radius-m">
                  <Image
                    alt="Project Preview"
                    src="/img/works/services/service27_4.jpg"
                    width={1400}
                    height={1000}
                  />
                </div>
              ...
              <div className="col-12 col-xl-5 mxd-project-cards__item mxd-grid-item anim-uni-scale-in-left">
                <div className="mxd-project-cards__inner bg-base-tint radius-m">
                  <Image
                    alt="Project Preview"
                    src="/img/works/services/service27_5.jpg"
                    width={1200}
                    height={1200}
                  />
                </div>

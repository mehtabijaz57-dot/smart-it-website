                ...
                <div className="mxd-block__content">
                  <div className="mxd-block__inner-headline loading__item">
                    ...
                    <a
                      ...
                      href="https://mail.google.com/mail/?view=cm&to=sales@smartitdigital.com" target="blank"
                      
                    >
                      <span className="btn-caption">@smartitdigital.com</span>
                      <i className="ph-bold ph-arrow-up-right" />
                    </a>
                    <p className="inner-headline__text t-large t-bright loading__item">
                      Got Questions? We’re Here to Help!
Discover straightforward answers about our services, how we work, and what it’s like to collaborate with us. If something isn’t clear, just reach out—we’re always ready to assist!
                    </p>
                  </div>
                </div>
              </div>

          ...
          <div className="mxd-menu__inner">
              ...
              <div className="menu-promo">
                <div className="menu-promo__content">
                  <p
                    ...
                    style={{ transitionDelay: "0.4s" }}
                  >
                   We design intelligent technology solutions
            ...
            >
              <p className="t-xsmall">
                © 2026 <a className="no-effect" href="#" target="_blank">Smart Information Technologies.</a> All rights reserved.{" "}
              </p>

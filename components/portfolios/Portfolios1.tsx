                ...
                <div className="col-12 col-xl-10 mxd-grid-item no-margin">
                  <div className="mxd-block__content">
                    <div className="mxd-block__inner-headline loading__item">
                      ...
                      Our Cloud Migration Strategy Portfolio
                      </h1>
                      <p className="inner-headline__text t-large t-bright">Smart Information Technologies specializes in enterprise cloud transformation, legacy system refactoring, and hybrid cloud implementation—without business disruption.</p>
                    </div>
                  </div>
                </div>

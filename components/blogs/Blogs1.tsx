          ...
          <div className="mxd-posts-area loading__fade">
            ...
            <div className="mxd-posts-container mxd-grid-item">
              ...
              {blogs2.map((featured) => (
                ...
                >
                  <Link className="post-featured__thumb" href={`ai-powered-products-blog`}>
                    <Image
                  ...
                  <div className="post-featured__categories">
                    {featured.categories.map((c) => (
                      ...
                      >
                        <a href="ai-powered-products-blog">{c}</a>
                      </span>
                    ))}
                  </div>
                  ...
                  <div className="post-featured__content">
                    ...
                    <h3 className="post-featured__title">
                      <Link href={`ai-powered-products-blog`}>{featured.title}</Link>
                    </h3>
                  ...
                  <div className="post-simple__content">
                    <div className="post-simple__descr">
                      ...
                      <div className="post-simple__title">
                        <h5>
                          <Link href={`designing-scalable-saas`}>{p.title}</Link>
                        </h5>
                      </div>
                    </div>
            ...
            <div className="mxd-sidebar mxd-grid-item">
                ...
                <ul className="widget__categories">
                  {sidebarCategories.map((c) => (
                    <li className="categories__item" key={c}>
                      <a href="designing-scalable-saas" className="categories__link">
                        {c}
                      </a>
                    </li>
                  ))}
                  ...
                  {blogs4.map((rp) => (
                    <li className="recent-post__item" key={rp.title}>
                      <div className="recent-post__thumb">
                        <Link href={`cybersecurity-in-the-age-blog`}>
                          <Image
                      ...
                      <div className="recent-post__content">
                        <div className="recent-post__meta">
                          <span className="meta-tag">
                            <StarSvg />
                            <a href="ai-powered-products-blog">{rp.category}</a>
                          </span>
                        </div>
                        <div className="recent-post__title">
                          <Link href={`ai-powered-products-blog`}>{rp.title}</Link>
                        </div>
                      </div>
                    </li>
                  ))}
              ...
              <div className="mxd-sidebar__widget radius-m widget-ad">
                <a className="widget__image" href="about-us" target="_blank">
                  <Image
                    alt="Ad Image"
                    src="/img/blog/1200x1320_ad-001.webp"
                    width={1200}
                    height={1320}
                  />
                </a>
              ...
              <div className="mxd-sidebar__widget bg-base-tint radius-m widget-about">
                ...
                <div className="widget__descr">
                  <p className="t-small">
                    Smart IT is a modern digital engineering company delivering AI-powered solutions, scalable SaaS platforms, enterprise web applications, and next-generation mobile experiences.
                  </p>
                </div>
              </div>
